...
const PORTS: Array = [
	...
	# ------------------------------------------------------------- MAR 2 ---
	# EL MAR DE LOS VIENTOS. Dos senas de identidad (pedidas por el usuario):
	#  · AQUI EMPIEZAN LOS CASTIGOS POR VACIO (el mar 1 es la escuela y no
	#    castiga): oro DOBLADO en las islas, calaveras en los puertos, robo de
	#    reloj en los abordajes. Cada tipo presenta el suyo en su primer nivel
	#    del mar (m2_01 isla, m2_03 puerto, m2_06 abordaje) via
	#    `level_director._explicar_handicap`.
	#  · EL VIENTO (`"viento": true`): un vendaval que, al pasar del umbral
	#    hacia la izquierda, INVIERTE LA CINTA. Se presenta en m2_08 y de ahi
	#    en adelante es el pan de cada dia. La intensidad la pone el TIPO del
	#    escenario (isla suave, puerto media, abordaje fuerte).
	# El jefe del mar es LA SIRENA (m2_25); su duelo esta pendiente de disenar.
	{
		"id": "m2_01",
		"sea": 2,
		"chef_rec": 16,
		"name": "Cala del Alisio",
		"desc": "La puerta del Mar de los Vientos. Aquí la clientela ya no perdona.",
		"client_mix": { "E": 7, "A": 2 },
		"arrival_span": 120.0,
		"patience_mult": 0.95,
		"goal_stars": 2,
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 16,
		"name": "Islote del Silbido",
		"desc": "El viento silba entre las rocas, pero aún no muerde.",
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 16,
		"name": "Puerto Ventisca",
		"desc": "Un puerto orgulloso donde la fama corre más que el viento.",
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 18,
		"name": "Cala del Banderín",
		"desc": "Mira el banderín del mástil: cuando enloquece, la cinta también.",
		"client_mix": { "E": 6, "A": 3 },
		"arrival_span": 130.0,
		"patience_mult": 0.95,
		"viento": true,
		"director": "mar2_viento",
		"goal_stars": 2,
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 18,
		"name": "Arrecife de las Rachas",
		"desc": "Las rachas peinan el arrecife de lado a lado.",
		"client_mix": { "E": 5, "A": 4, "G": 1 },
		"arrival_span": 125.0,
		"patience_mult": 0.9,
		"bite_speed": 1.2,
	...
	},
	{
		...
		"chef_rec": 19,
		"name": "Puerto Molino",
		"desc": "Las aspas no paran nunca. Tu cinta tampoco sabrá hacia dónde.",
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 19,
		"name": "Dársena del Levante",
		"desc": "Con el levante soplando, tres recetas son un tesoro.",
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 19,
		"name": "Rumbo del Tifón",
		"desc": "Abordar con este viento es de locos. Cocinar, más todavía.",
		"client_mix": { "E": 5, "A": 4, "G": 1 },
		"arrival_span": 130.0,
		"patience_mult": 0.88,
		"viento": true,
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 20,
		"name": "Flota del Poniente",
		"desc": "El poniente trae capitanes con hambre atrasada.",
	...
	},
	{
		...
		"desc": "De noche los farolillos aguantan el viento mejor que los clientes.",
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 21,
		"name": "Presa del Mistral",
		"desc": "El mistral empuja el barco... y los bocados.",
		"client_mix": { "E": 5, "A": 4, "G": 1 },
		"arrival_span": 125.0,
		"patience_mult": 0.88,
		"bite_speed": 1.15,
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 21,
		"name": "Muelle de las Veletas",
		"desc": "Cien veletas y ninguna se pone de acuerdo.",
	...
	},
	{
		...
		"chef_rec": 22,
		"name": "Isla Cometa",
		"desc": "Aquí el viento se lleva hasta las cometas de los niños.",
		"client_mix": { "E": 6, "A": 4, "G": 2 },
		"arrival_span": 130.0,
		"patience_mult": 0.88,
		"viento": true,
	...
	},
	{
		...
		"sea": 2,
		"chef_rec": 22,
		"name": "Cala de los Molinillos",
		"desc": "Molinillos de papel en cada ventana. Giran sin parar.",
	...
	},
	{
		...
		"chef_rec": 23,
		"name": "Tromba del Sur",
		"desc": "La tromba llega sin avisar. Como los capitanes.",
	...
	},
	{
		...
		"patience_mult": 0.88,
		"goal_stars": 2,
		# JEFE DEL MAR 2: LA SIRENA. Su duelo esta PENDIENTE de disenar (de
		# momento el nivel juega como una cueva normal y no puede superarse:
		# `boss` sin coreografia deja las estrellas en 1 como mucho).
		"star_money": [55, 95, 150],
		"boss": "sirena",
	},
]
